  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <h1 className="mt-14 text-white-normal text-5xl font-bold leading-tight">
        ...
        <p className="mt-4 text-sm text-gray-300 leading-relaxed">
          Após criar seu bolão, vocè receberá um código que poderá usar para
      ...
      <Image src={appPreviewImg} alt="Prévia mobile" quality={100} />
    </div>
  );
}
